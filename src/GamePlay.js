...
GamePlayManager = {
    ...
    create: function(){
        ...
        // linea 24 el tamaño del objeto
        // this.horse.alpha = 0.5; opacidad del objeto
        ...
        // console.log('newExplosion:' + newExplosion);

        // this.explosion = game.add.sprite(100,100, 'explosion'); se reemplaza por el codigo de abajo
        for(var i=0; i<10; i++){
        ...
        this.timerGameOver = game.time.events.loop(Phaser.Timer.SECOND, function(){
           if(this.flagFirstMouseDown){
            ...
            if(this.totalTime<=0){
                ...
                this.endGame = true;
                this.showFinalMessage('Se acabo el tiempo');
            }
           }
        }, this);
    ...
    update: function(){
        ...
        if(this.flagFirstMouseDown && !this.endGame){
            ...
            // Funcion para que los peces se muevan
            this.fishes.x+=0.3;
            if(this.x>1300){
                this.fishes.x = -300;
            }

            // Funcion para hacer mover el tiburon
            this.shark.x--;
            if(this.shark.x<-300){
                this.shark.x=1300;
            }

            // this.horse.angle +=1; para darle rotacion al objeto dentro de su eje
            var pointerX = game.input.x;
            var pointerY = game.input.y;
    
            // console.log('x:'+pointerX);
            // console.log('y:'+pointerY); imprimen las direcciones del puntero en la consola
            ...
            // lineas 45 56 ajustan la velocidad del objeto hacia el puntero
            ...
            for(var i=0; i<AMOUNT_DIAMONDS; i++){
                ...
                if(this.diamonds[i].visible && this.isRectanglesOverlapping(rectHorse, rectDiamond)){
                    ...
                    if(explosion!=null){
                        ...
                        // explosion.x = this.diamonds[i].x;
                        // explosion.y = this.diamonds[i].y;
                        // explosion.tweenScale.start();
                        // explosion.tweenAlpha.start();
                    }
                }
